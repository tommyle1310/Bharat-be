...
SELECT id, name, company_name, case_option_id, email, mobile, alternate_mobile, password, address, city, state_id, pincode, information_for_buyer, team_remarks, pan_number, aadhaar_number, security_deposit, bid_limit, expiry_date, renew_date, buyer_status, buyer_zone, interested_states, aadhaar_front, aadhaar_back, pan_image, police_verification, verify_status, is_dummy, firebase_token, notification_opened, added_on, reset_token, police_verification_status, pan_verification_status, aadhaar_verification_status, is_logged_in, category_id, gst_no, buyer_photo_doc_id, aadhar_front_doc_id, aadhar_back_doc_id, pan_doc_id, pcc_doc_id, gst_certificate_doc_id, other_doc_id, city_id, salt, business_vertical, business_company_id, buyer_photo_ext, aadhar_front_ext, aadhar_back_ext, pan_ext, pcc_ext, gst_ext, other_ext, cc_ext, shipping_entity, shipping_address, shipping_state_id, shipping_city_id, shipping_pin, shipping_pan, shipping_tan, shipping_gst, billing_entity, billing_address, billing_state_id, billing_city_id, billing_pin, billing_pan, billing_tan, billing_gst, father, dob, digilocker_aadhaar, digilocker_name, digilocker_dob, digilocker_gender, digilocker_address, digilocker_state, digilocker_pin, digilocker_father, pan_api_firstname, pan_api_lastname, pan_api_aadhaar_no, pan_api_aadhaar_linked, pan_api_email, pan_api_dob, pan_api_identity_type, pan_api_mobile, pan_api_full_address, pan_verified_dttm, pan_verified_by
FROM prod_indus_db.buyers;