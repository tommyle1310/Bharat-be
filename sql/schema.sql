...
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  `vehicle_make_id` smallint unsigned NOT NULL,
  `vehicle_model_id` smallint unsigned NOT NULL,
  `vehicle_variant_id` smallint unsigned NOT NULL,
  `manufacturing_year` varchar(10) DEFAULT NULL,
  `vehicle_type_id` tinyint unsigned DEFAULT NULL,
  `fuel_type_id` tinyint unsigned DEFAULT NULL,
  `transmission_type_id` tinyint unsigned DEFAULT NULL,
  `vehicle_ownership_type_id` tinyint unsigned DEFAULT NULL,
  `vehicle_category_id` tinyint unsigned DEFAULT NULL,
  `vehicle_subcategory_id` tinyint unsigned DEFAULT NULL,
  `seller_id` int unsigned NOT NULL,
  `regs_no` varchar(20) DEFAULT NULL,
  `vehicle_location` varchar(255) DEFAULT NULL,
  `vehicle_manager_id` mediumint unsigned DEFAULT NULL,
  ...
  `top_bidder_id` int unsigned DEFAULT NULL,
  ...
  `auction_type` tinyint unsigned DEFAULT NULL,
  `challan_amt` int unsigned DEFAULT NULL,
  ...
  `odometer_reading` mediumint unsigned DEFAULT NULL,
  `ownership_serial` varchar(10) DEFAULT NULL,
  `parking_charges` smallint unsigned DEFAULT NULL,
  `pending_challans` int unsigned DEFAULT NULL,
  `permit_type` int unsigned DEFAULT NULL,
  `permit_validity` date DEFAULT NULL,
  `rc_availability` tinyint unsigned DEFAULT NULL,
  `registeration_type_id` int unsigned DEFAULT NULL,
  `registration_year` varchar(10) DEFAULT NULL,
  `repo_date` date DEFAULT NULL,
  `reserve_price` int unsigned DEFAULT NULL,
  `road_tax_validity` varchar(20) DEFAULT NULL,
  `rto_dtls` varchar(255) DEFAULT NULL,
  `running_status` tinyint unsigned DEFAULT NULL,
  ...
  `vehicle_city_id` int unsigned DEFAULT NULL,
  `vehicle_state_id` tinyint unsigned DEFAULT NULL,
  `auction_status_id` tinyint unsigned DEFAULT NULL,
  `vehicle_image_id` int unsigned DEFAULT NULL,
  `expected_price` int unsigned DEFAULT NULL,
